prep()
{
    mkdir DustMaps
    cd DustMaps
    curl -O http://lsst-web.ncsa.illinois.edu/~krughoff/data/dust_maps/SFD_dust_4096_ngp.fits
    curl -O http://lsst-web.ncsa.illinois.edu/~krughoff/data/dust_maps/SFD_dust_4096_sgp.fits
